...
import ru.praktikum.api.user.Credentials;
import ru.praktikum.api.user.User;
import ru.praktikum.api.user.UserClient;
import ru.praktikum.api.user.UserGenerator;
import ru.praktikum.pages.LoginPage;
import ru.praktikum.pages.MainPage;
import ru.praktikum.pages.ProfilePage;

public class TransitionsBetweenFormsTest extends BaseTest{
